...
mortalityCasesDataFrame <- confirmedCasesDataFrame [ confirmedCasesDataFrame$FECHA_DEF != notDead,c("FECHA_INGRESO","RESULTADO","ENTIDAD_RES","MUNICIPIO_RES","FECHA_DEF")]
